  ...
  return (
    <>
      ...
      <div className="Capacidad">
        <h2 className="Capacidad__titulo">
          Tu Centro Médico a máxima capacidad
        </h2>
        <div className="Capacidad__textos">
          ...
          <p>
            Resolvemos problemas de comunicación entre instituciones de salud y
            pacientes, desde <strong>confirmaciones</strong> hasta{' '}
            <strong>listas de espera</strong>,{' '}
            <strong>controles preventivos</strong> y{' '}
            <strong>bloqueos de agenda</strong>.{' '}
          </p>
          <p>
            Y lo hacemos todo de manera <strong>empática</strong> y{' '}
            <strong>respetuosa</strong>.
          </p>
