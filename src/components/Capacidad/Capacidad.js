  ...
  return (
    <div className="Capacidad">
      ...
      <div className="Capacidad__textos">
        ...
        <p>
          Resolvemos problemas de comunicación <br />
          entre instituciones de salud y pacientes, desde <br />
          <strong>confirmaciones</strong> hasta <strong>listas de espera</strong>, <br />
          <strong>controles preventivos</strong> y <strong>bloqueos de agenda</strong>.
        </p>
