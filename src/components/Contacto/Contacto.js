    ...
    <div className="Contacto">
      <div className="Contacto__contenedor_central">
        <div className="Contacto__contenedor_texto">
          ...
          <p className="Contacto__bajada">Danos 30 minutos para mostrarte como podemos ayudarte a solucionar tu proceso de confirmación de pacientes. Nuestros clientes ahorran miles de horas de coordinación y aumentan sus ingresos disminuyendo el No Show de pacientes.</p>
        </div>
        <div className="Contacto__contenedor_formulario">
          <form className="Contacto__formulario">
            <div className="Contacto__campo Contacto__campo--pequeño">
            ...
            <div className="Contacto__campo Contacto__campo--pequeño">
              <label className="Contacto__label_campo">Apellido</label>
              <input
                type="text"
                required
                className="Contacto__input"
